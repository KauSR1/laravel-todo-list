...
@section('content')
    ...
    <div class="container-fluid min-vh-100 p-0">
        <div class="row g-0 min-vh-100">
            ...
            <!-- COLUNA ESQUERDA: Branding e Conceito (Igual ao Login para manter consistência) -->
            <div
                ...
                <!-- Centro da Esquerda: Frase de Impacto voltada para criação de conta -->
                <div class="z-1 my-auto py-5" style="max-width: 500px;">
                    ...
                    <p class="text-light text-opacity-75 lead fs-6 mb-0">
                        Crie sua conta em segundos e tenha o controle total das suas notas, ideias e projetos diários em
                        um só lugar.
                    </p>
                </div>
            ...
            <!-- COLUNA DIREITA: O Formulário de Registro -->
                ...
                <div class="w-100" style="max-width: 400px;">
                    ...
                    <form action="{{route('register.store')}}" method="post" novalidate autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text_email" class="form-control bg-light border-0 py-2.5 fs-6 shadow-none"
                                       id="text_email"
                                       name="text_email"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text_password"
                                       class="form-control bg-light border-0 py-2.5 fs-6 shadow-none"
                                       id="text_password"
                                       name="text_password"
                                       placeholder="••••••••"
                                       required>
                        ...
                        <!-- Confirm Password -->
                        <div class="mb-4">
                            <label for="text_password_confirmation" class="form-label text-dark small fw-semibold">Confirmar
                                Password</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-0 text-muted ps-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <div class="text-center mt-4">
                        <p class="text-muted small mb-0">
                            Já tem uma conta?
                            <a href="{{Route('login')}}" class="text-dark fw-semibold text-decoration-none">Faça
                                login</a>
                        </p>
                    </div>
